...
char list_is_full(obj_list *listo)
{
	return(listo->item_count == listo->current_max_size);
}

void list_grow(obj_list *old_listo)
{
	int i;
	obj_list new_listo;
...
void list_make(obj_list *listo, int start_size, char growable)
{
...
void* list_get_name(obj_list *listo, char *name_to_find)
{
	int i = 0;
